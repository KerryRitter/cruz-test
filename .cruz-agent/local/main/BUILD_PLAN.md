...
|---|---------|-------------|-------|--------|-------|
| 1 | `subreddits` | Create communities, discover and join them, manage membership | community-scoped | done | |
| 2 | `posts` | Submit text posts to a subreddit, view post detail | community-scoped + user-authored | done | |
| 3 | `votes` | Upvote/downvote posts; score tracked per post | user-specific | done | |
| 4 | `feed` | Home feed (subscribed communities) + subreddit feed, sorted by Newest or Top | personalized | done | |
| 5 | `comments` | Nested threaded comments on posts (recursive, unlimited depth) | community-scoped + user-authored | done | |
| 6 | `karma` | User karma score (sum of votes received on posts & comments) | user-specific | done | |
| 7 | `moderation` | Ban users from subreddits, remove posts, promote moderators | community-scoped | done | |
